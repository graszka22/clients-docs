...
docs](https://jellyfish-dev.github.io/jellyfish-docs/). This section provides a
brief description aimed at frontend developers
...
![Room example](./img/room_example.png)
...
![Connecting and joing the room](./img/connection.png)

The parts that you need to implement are marked in blue, things handled by
...
![Connecting and joing the room with dashboard](./img/dashboard_connection.png)
